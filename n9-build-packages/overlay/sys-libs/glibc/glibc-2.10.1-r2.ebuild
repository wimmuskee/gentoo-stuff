...
# $Header: /var/cvsroot/gentoo-x86/sys-libs/glibc/Attic/glibc-2.10.1-r1.ebuild,v 1.31 2015/03/14 08:19:41 vapier dead $

inherit autotools eutils versionator toolchain-funcs flag-o-matic gnuconfig multilib systemd unpacker multiprocessing
...
eblit-src_unpack-post() {
	einfo "Patching for newer make and autotools versions."
	epatch "${FILESDIR}"/configure.in-makeversion.patch
	cd "${S}"
